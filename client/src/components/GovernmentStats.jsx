...
// Import Chart.js components individually (removed Line chart components)
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
...
// Register Chart.js components (removed Line chart components)
ChartJS.register(
  CategoryScale,
  LinearScale,
  BarElement,
...
const GovernmentStats = () => {
  ...
  if (loading) {
    return (
      <div className="government-stats-container">
        <div className="loading">Loading government statistics...</div>
      </div>
    );
  }
  ...
  return (
    <div className="government-stats-container">
      <div className="stats-header">
        <h2>Government Crisis Analytics Dashboard</h2>
      ...
      <div className="stats-summary">
        ...
        <div className="summary-item">
          ...
          <p>{resolutionRate}% ({completed}/{total})</p>
        </div>

        <div className="summary-item">
          <h3>Pending Cases</h3>
          <p>{pending} cases need attention</p>
        </div>

        <div className="summary-item">
          <h3>Total Cases</h3>
          <p>{stats.totalCrises} total cases reported</p>
        </div>
      </div>
    </div>
  );
